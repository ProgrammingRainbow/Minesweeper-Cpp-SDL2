...
class Game {
    ...
    private:
        ...
        void setSize(std::size_t new_rows, std::size_t new_columns,
                     int new_scale, const std::string &size_str);
        void setDifficulty(double new_diff, const std::string &diff_str);
